...
exports.run = (client, message, args) => {
  ...
  .addField(':warning: **Uyarı** :warning:', '**`sustur` Adlı Komutu Özel Mesajlarda Kullanamasın**')
  ...
  if (!modlog) return message.reply('**`ceza-takip` Kanalını Bulamıyorum**').catch(console.error);
  if (!muteRole) return message.reply('**`Muted` Adlı Rolü Bulamıyorum**').catch(console.error);
